...
# modules
from visual_encoders.vae.models.get_model import get_model
# datasets
from visual_encoders.vae.datasets.get_dataset import get_image_dataset
# util functions
from visual_encoders.vae.utils import prepare_logdir, save_config, log_line, get_config
from visual_encoders.vae.eval.eval_metrics import eval_im_metric, evaluate_validation_loss
...
def train_vae(config_path='./visual_encoders/vae/configs/panda.json'):
    # load config
    try:
    ...
    run_name = f'{ds_name}_{model_type}' + run_prefix
    log_dir = prepare_logdir(runname=run_name, src_dir='visual_encoders/vae/logs')
...
if __name__ == "__main__":
    ...
    conf_path = './visual_encoders/vae/configs/ppp_cube.json'
    # conf_path = './visual_encoders/vae/configs/scene.json'
    # conf_path = './visual_encoders/vae/configs/push_tetris.json'
