...
class HECRL_Env_DS(Dataset):
    def __init__(self, root, mode, ep_len=None, sample_length=1, res=128, episodic=False):
...
if __name__ == '__main__':
    ...
    # mode = 'train'
    mode = 'valid'
    ds = HECRL_Env_DS(root, mode, ep_len=400, sample_length=1, res=128)
    print(ds[0][0].shape)
    print(ds[0])
