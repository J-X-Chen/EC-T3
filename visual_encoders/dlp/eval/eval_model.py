...
from visual_encoders.dlp.utils.util_func import plot_keypoints_on_image_batch, \
    plot_bb_on_image_batch_from_z_scale_nms, plot_bb_on_image_batch_from_masks_nms, plot_glimpse_obj_on


def evaluate_validation_elbo(model, ds, data_root_dir, epoch, tasks=None, batch_size=100, recon_loss_type="vgg", device=torch.device('cpu'),
    ...
    dataloader = DataLoader(dataset, shuffle=True, batch_size=batch_size, num_workers=num_workers, drop_last=True)
